...
const Header5: React.FC<HeaderProps> = ({ handleOpen, handleRemove, handleRemove2, scroll }): JSX.Element => {
  ...
  return (
    <header className={`main-header header-style-five ${scroll ? "fixed-header" : ""}`}>
      {/* Header Top */}
      <div className="header-top Styles">
        <div className="inner-container">
          <div className="top-left">
            <ul className="list-style-one light">
             {/*  <li>
                <i className="fa fa-building"></i> Infinity Software Labs
              </li> */}
              <li>
        ...
        <div className="main-box">
          ...
          <div className="nav-outer">
            <nav className="nav main-menu">
              <NavLinks extraClassName="navigation" />
            </nav>
          </div>
        ...
        <nav className="menu-box">
          <div className="upper-box">
            <div className="nav-logo">
              <Link href="/">
                <Image src="/assets/images/logo.png" alt="Logo" width={120} height={35} />
              </Link>
            </div>
      ...
      <div className={`sticky-header ${scroll ? "fixed-header animated slideInDown" : ""}`}>
        <div className="auto-container">
          <div className="inner-container">
            <div className="logo">
              <Link href="/" title="">
                <Image src="/assets/images/logo.png" alt="Logo" width={130} height={35} />
              </Link>
            </div>
            <div className="nav-outer">
